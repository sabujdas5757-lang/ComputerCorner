          ...
          >
            {products.map((product) => (
              <motion.div
                key={product.id}
                whileHover={{ y: -5 }}
                className="min-w-[240px] md:min-w-[300px] bg-white rounded-2xl overflow-hidden shadow-2xl snap-start flex flex-col group/card cursor-pointer"
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-sm md:text-base font-bold text-gray-900 line-clamp-2 mb-1 group-hover/card:text-primary transition-colors">
                    {product.name}
                  </h3>
